...
void CreateConfigFile()
{
    ...
    Configuration::setSigIDOffset(data.at("sigIDOffset").get<std::vector<std::string>>());
...
bool PlatformInitialization()
{
    ...
    else if (plat_info->family == TURIN_FAMILY_ID)
    {
        ...
        BlockId = {BLOCK_ID_1, BLOCK_ID_2, BLOCK_ID_3, BLOCK_ID_24, BLOCK_ID_33, BLOCK_ID_36, BLOCK_ID_37,
