...
void triggerColdReset()
{
    ...
    std::string CurrentHostState = GetProperty<std::string>(bus, "xyz.openbmc_project.State.Host",
                                           "/xyz/openbmc_project/state/host0",
                                           "xyz.openbmc_project.State.Host", "CurrentHostState");

    if(CurrentHostState.compare("xyz.openbmc_project.State.Host.HostState.Off") == 0)
    {
