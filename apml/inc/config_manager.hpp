...
static constexpr auto objectPath = "/com/amd/crashdump/Configuration";

using AttributeType = sdbusplus::common::com::amd::ras::Configuration::AttributeType;
using Base = sdbusplus::com::amd::RAS::server::Configuration;

using AttributeName = std::string;
using AttributeValue = std::variant<bool, std::string, int64_t, std::vector<std::string>, std::map<std::string, std::string>>;
using ConfigTable = std::map<std::string, std::tuple<AttributeType, std::string, std::variant<bool, std::string, int64_t, std::vector<std::string>, std::map<std::string, std::string>>, int64_t>>;
