...
template<typename T> void calculate_time_stamp(const std::shared_ptr<T>&);
template<typename T> void write_to_cper_file(const std::shared_ptr<T>&,std::string,uint16_t);
template<typename T> void dump_cper_header_section(const std::shared_ptr<T>&, uint16_t,uint32_t, std::string);
template<typename T> void dump_error_descriptor_section(const std::shared_ptr<T>&,uint16_t,std::string,uint32_t *);
template<typename T> void dump_proc_error_section(const std::shared_ptr<T>&,uint8_t,struct ras_rt_valid_err_inst,
                                        uint8_t,uint16_t,uint32_t *,uint64_t *);
template<typename T> void dump_pcie_error_info_section(const std::shared_ptr<T>&,uint16_t,uint16_t);
template<typename T> void dump_proc_error_info_section(const std::shared_ptr<T>&, uint8_t,uint16_t,
                                 uint64_t *,uint32_t);
...
extern uint16_t systemRecovery;
extern bool harvestuCodeVersionFlag;
extern bool harvestPpinFlag;
extern bool McaPollingEn;
extern bool DramCeccPollingEn;
extern bool PcieAerPollingEn;
extern bool McaThresholdEn;
extern bool DramCeccThresholdEn;
extern bool PcieAerThresholdEn;

extern uint16_t McaPollingPeriod;
extern uint16_t DramCeccPollingPeriod;
extern uint16_t PcieAerPollingPeriod;
extern uint16_t McaErrCounter;
extern uint16_t DramCeccErrCounter;
extern uint16_t PcieAerErrCounter;
extern std::vector<std::string> sigIDOffset;
